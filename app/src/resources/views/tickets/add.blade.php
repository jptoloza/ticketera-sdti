        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="uc-form-group mb-3">
              ...
              <input id="subject" name="subject" type="text" class="uc-input-style" placeholder="Ingrese asunto"
                required />
            </div>
          </div>
              ...
              <div class="uc-form-group mb-3">
                ...
                <select name="status" id="status" class="uc-input-style select2" required>
                  ...
                  @foreach ($status as $state)
                    <option value="{{ $state->id }}" @if (App\Http\Helpers\UtilHelper::globalKey('STATUS_OPEN') == $state->id) selected="selected" @endif>
              ...
              <div class="uc-form-group mb-3">
                ...
                <select name="priority" id="priority" class="uc-input-style select2" required>
                  ...
                  @foreach ($priorities as $priority)
                    <option value="{{ $priority->id }}" @if (App\Http\Helpers\UtilHelper::globalKey('PRIORITY_HALF') == $priority->id) selected="selected" @endif>
        ...
        $('#queue').change(function() {
          ...
          $.ajax({
            ...
            success: function(data) {
              ...
              $('#assigned_agent').empty().append('<option value="" selected>Seleccionar</option>').append(

    ...
    <div class="pt-2">
        ...
        <div class="mt-2 bg-white p-2 border border-gray rounded-1">
            <div class="p-2 p-size--lg">
                En esta sección podrá gestionar los estados de los tickets del sistema.
            </div>

            <div class="p-2 mt-4 mb-0">
                <a href="{{ route('admin_status_addForm') }}" class="uc-btn btn-primary btn-inline">

...
@section('content')
  <div class="pt-2">
    ...
    <div class="mt-2 bg-white p-2 border border-gray rounded-1">
      ...
      <div class="mx-2">
        <form name="actionForm" id="actionForm" method="POST" action="{{ route('admin_units_add') }}">
          @csrf
          <h4>Nueva Unidad</h4>
          ...
          <div class="uc-form-group">
            ...
            <input id="global_key" name="global_key" type="text" class="uc-input-style" placeholder="Ingrese código"/>
          </div>
          <div class="uc-form-group">
            <label for="first_name">Unidad <span class="text-danger">*</span></label>
            <input id="name" name="name" type="text" class="uc-input-style" placeholder="Ingrese nombre unidad"
              required />
          </div>
          <div class="uc-form-group">
            <div>

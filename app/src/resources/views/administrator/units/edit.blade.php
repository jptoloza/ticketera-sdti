...
@section('content')
  <div class="pt-2">
    <ol class="uc-breadcrumb">
      ...
      <li class="uc-breadcrumb_item current bc-siga">Unidades</li>
    </ol>
    ...
    <div class="mt-2 bg-white p-2 border border-gray rounded-1">
      <div class="p-2 p-size--lg">
        Esta sección permite administrar la información base de las unidades de los usuarios del sistema, facilitando un
      ...
      <div class="p-2 mb-2 pl-0">
        <a href="{{ route('admin_units') }}" class="uc-btn d-block fw-bold text-decoration-none">
      ...
      <div class="mx-2">
        <form name="actionForm" id="actionForm" method="POST" action="{{ route('admin_units_edit') }}">
          @csrf
          ...
          <div class="uc-form-group">
            ...
            <input id="code" name="code" type="text" value="{{ $unit->code }}" class="uc-input-style"
              placeholder="Ingrese código"/>
          </div>

          <div class="uc-form-group">
            <label for="first_name">Unidad <span class="text-danger">*</span></label>
            <input id="name" name="name" type="text" class="uc-input-style" placeholder="Ingrese nombre estado"
              required value="{{ $unit->unit }}" />
          </div>

          <div class="uc-form-group">
            <div>
              <label for="active">Unidad Validada <span class="text-danger">*</span></label>
            </div>
            <div>
              <input type="radio" name="validate" value="1" @if ($unit->validate) checked @endif />
              <label class="fw-normal">Si</label>
            </div>
            <div>
              <input type="radio" name="validate" value="0" @if (!$unit->validate) checked @endif />
          ...
          <div class="uc-form-group">
            <div>
              <label for="active">Unidad Activa <span class="text-danger">*</span></label>
            </div>
            <div>
              <input type="radio" name="active" value="1" @if ($unit->active) checked @endif />
              <label class="fw-normal">Si</label>
            </div>
            <div>
              <input type="radio" name="active" value="0" @if (!$unit->active) checked @endif />
              <label class="fw-normal">No</label>
            </div>
          </div>

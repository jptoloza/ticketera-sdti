...
@section('content')
  <div class="pt-2">
    ...
    <div class="mx-2">
      <form name="actionForm" id="actionForm" method="POST" action="{{ route('admin_roles_users_add') }}">
      @csrf
      <input type="hidden" name="role_id" value="{{ $role->id }}" />
      <h4>Asignar Usuarios a Rol: {{ $role->role }}</h4>
      ...
      <tr>
        ...
        <a href="{{ route('admin_roles_users_delete', $key) }}" class="btnDelete" title="Eliminar"><i

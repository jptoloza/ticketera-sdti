...
@section('content')
    <div class="pt-2">
        ...
        <div class="mt-2 bg-white p-2 border border-gray rounded-1">
            ...
            <div class="mx-2">
                <form name="actionForm" id="actionForm" method="POST" action="{{ route('admin_queues_edit') }}">
                    @csrf
                    ...
                    <div class="uc-form-group">
                        ...
                        <div>
                            <input type="radio" name="active" value="1" @if ($queue->active) checked @endif/>
                            <label class="fw-normal">Si</label>
                        </div>
                        <div>
                            <input type="radio" name="active" value="0" @if (!$queue->active) checked @endif/>

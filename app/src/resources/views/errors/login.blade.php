...
@section('content')
          ...
          <div class="uc-card card-bg--gray" id="error-404">
            <div class="uc-card_body--xl">
              ...
              <a href="/logout" class="uc-link text-weight--medium">
                En breve, será redirigido a la página de cierre SSO-CAS. <i class="uc-icon">keyboard_arrow_right</i>
              </a>
            </div>
          </div>
        </div>
  ...
  <script>
    // Redirige a otra página después de 5 segundos (5000 milisegundos)
    setTimeout(function() {

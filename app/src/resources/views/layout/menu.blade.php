{{-- <div class="m-4 mt-3 ms-3 mb-1 title-menu">
  <div class="d-flex  mb-3">
    <button href="#" class="uc-btn btn-primary vw-100">
      Nuevo Ticket&nbsp;&nbsp;
  ...
  <ul class="uc-navbar-side">
    ...
    <li>
      ...
      <ul class="uc-navbar-side">
        <li>
          <a href="#" class="uc-navbar-side_label"> Cola1 <i class="uc-icon">keyboard_arrow_right</i> </a>
          <ul class="uc-navbar-side">
            <li>
              <a href="">
                Tickets no asignados (0)
                <i class="uc-icon">keyboard_arrow_right</i>
              </a>
            </li>
            <li>
      ...
      <ul class="uc-navbar-side">
        @forelse ($userQueues as $queue)
          <li>
            ...
            <ul class="uc-navbar-side">
              <li>
                <a href="{{ route('admin_queues_users', $queue->id) }}">
                  Tickets no asignados (0)
                  <i class="uc-icon">keyboard_arrow_right</i>
                </a>
              </li>
